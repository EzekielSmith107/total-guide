...
import cheatSheet from '../../images/Cheat Sheet.pdf'
    ...
    <div className={classes.cheatsheetContainer} id='cheatsheet'>
        <div className={classes.cardContainer}>
          <Card>
            ...
            <a href={cheatSheet} download='Cheat Sheet' target='blank' >
              <button className={classes.downloadBtn}>Download Cheat Sheet</button>
            </a>
        </Card>
        </div>
    </div>
